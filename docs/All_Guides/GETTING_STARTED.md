# Getting Started with GoCopier

Welcome to **GoCopier**, the official Go client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install GoCopier using your language's package manager:
